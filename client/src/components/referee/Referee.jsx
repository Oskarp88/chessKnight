...
export const isMoveValid = (pieceType, selectedPiece,x,y,pieces, enPassantTarget, currentTurn) => {
    switch (pieceType) {
      case PieceType.PAWN:
      ...
      case PieceType.KING:
        return isMoveValidForKing(selectedPiece, x, y, pieces, currentTurn);
  ...
  export const getMovesFunction = (pieceType, selectedPiece, pieces, enPassantTarget, currentTurn) => {
    switch (pieceType) {
      case PieceType.PAWN:
      ...
      case PieceType.KING:
        return getPossibleKingMoves(selectedPiece, pieces, currentTurn);
      default:
        return [];
    }
  };
