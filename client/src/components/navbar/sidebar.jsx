      ...
      >
        ...
        <div className="menu">
          ...
          >
              {
                theme === 0 ? 
                <svg xmlns="http://www.w3.org/2000/svg" style={{color: chessColor.color1}} width='25'  height='25'  fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" style={{color: chessColor.color1}} width='25'  height='25' fill="currentColor" className="bi bi-moon-stars-fill" viewBox="0 0 16 16">
