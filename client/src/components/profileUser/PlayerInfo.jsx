        ...
        <div className={style.playerRating}>{
          time === 60 || time === 120? <>
           ...
           {elo}
            ...
            <svg style={{ color: '#4CAF50', marginRight: '7px', marginLeft: '2px', marginTop: '-5px'  }} xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
