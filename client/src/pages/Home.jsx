      ...
      <div className={style.fondoDatos} >
        ...
        <div className={style.containerStatsRating} >        
          <div className={style.containerNivel} 
             style={stast === 'fast' 
                     ? {border: '2px solid #229954' , background: 'rgba(162, 217, 206 ,0.4)'} 
                     : stast === 'blitz' 
                     ? {border: '2px solid #F4D03F', background: 'rgba(249, 231, 159 ,0.4)'} 
                     : {border: '2px solid #F39C12 ', background: 'rgba(250, 215, 160,0.4)'}}
          >
            {!user?
