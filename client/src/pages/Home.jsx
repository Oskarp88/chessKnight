...
export function Home() {
  ...
  return (
    <div className={style.container} style={auth?.user ? {background: chessColor.fondo, paddingBottom: '4rem'}: {background: chessColor.fondo}}>
          ...
          <div className={style.table}>
             <div className={style.chevron} onClick={() => handleFormer()}>
              <svg 
                ...
                style={ paginate === 1 ? {color: '#50c256'} : paginate === 2 ? {color: '#FFEB3B'} : {color: '#F9A825'}}  
                fill="currentColor" 
                width="40" height="40"
      ...
      </div>
     {
      ...
      <div className={style.fondoDatos} ref={miContaineHistorial}>
        ...
        <div className={style.scrollableContainer}>
          <h3 style={{color: chessColor.titulo}}>{language?.game_history.toUpperCase()}</h3>
          <div>
          ...
          <div className={style.gameOverModal}>
             ...
             <div className={style.body}>                 
              ...
              <div className={style.buttons}>
                <a className={style.a} onClick={() => createRoom(auth?.user?._id,  60)}>
                  1 min
                  <div className={style.icon}>
                    <div className={style.arrow}></div>
                  </div>
                </a>
                <a className={style.a} onClick={() => createRoom(auth?.user?._id, 120)}>
                  2 min
                  <div className={style.icon}>
                    <div className={style.arrow}></div>
                  </div>
                ...
                <div className={style.buttons}>          
                  <a className={style.a} onClick={() => createRoom(auth?.user?._id, 180)}>
                    3 min
                    <div className={style.icon}>
                      <div className={style.arrow}></div>
                    </div>
                  </a>
                  <a className={style.a} onClick={() => createRoom(auth?.user?._id, 300)}>
                    5 min
                    <div className={style.icon}>
                    <div className={style.arrow}></div>
                  </div>
              ...
              <div className={style.buttons}>
                <a className={style.a} onClick={() => createRoom(auth?.user?._id,  600)}>
                  10 min
                  <div className={style.icon}>
                    <div className={style.arrow}></div>
                  </div>
                </a>
                <a className={style.a} onClick={() => createRoom(auth?.user?._id,  1200)}>
                  20 min
                  <div className={style.icon}>
                    <div className={style.arrow}></div>
                  </div>
