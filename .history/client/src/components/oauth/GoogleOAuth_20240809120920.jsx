...
function GoogleOAuht() {
  ...
  const handleGoogleClick = async () => {
    try {
      ...
      const ipResponse = await axios.get('https://chessknigth-22fe0ebf751e.herokuapp.com/api/auth/get-ip');
      const userIP = ipResponse.data.ip;
      console.log('User IP:', userIP);

      // Geolocalización basándose en la IP
      const geoResponse = await axios.get(`https://chessknigth-22fe0ebf751e.herokuapp.com/api/auth/get-geo/${userIP}`);
      ...
      const response = await axios.post('https://chessknigth-22fe0ebf751e.herokuapp.com/api/auth/google', {
