...
function GoogleOAuht() {
  ...
  const handleGoogleClick = async () => {
    try {
      ...
      const ipResponse = await axios.get('https://git.heroku.com/chessknigth.git/api/auth/get-ip');
      const userIP = ipResponse.data.ip;
      console.log('User IP:', userIP);

      // Geolocalización basándose en la IP
      const geoResponse = await axios.get(`https://git.heroku.com/chessknigth.git/api/auth/get-geo/${userIP}`);
      ...
      const response = await axios.post('https://git.heroku.com/chessknigth.git/api/auth/google', {
