...
function Notifications() {
    ...
    <div className={style.notifications}>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-bell" viewBox="0 0 16 16">
