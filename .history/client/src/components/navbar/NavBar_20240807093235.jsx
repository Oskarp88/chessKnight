    ...
    <div className={styles.rightSection}>
      ...
      <div onClick={handleThemeToggle} className={styles.color} style={{borderLeft: chessColor.border}}>
        <div className={styles.div}>
          {
            theme === 0 ? 
            <svg xmlns="http://www.w3.org/2000/svg" width='25'  height='25' height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
