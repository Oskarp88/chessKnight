    ...
    <div className={styles.rightSection}>
      <Link to={"/"} className={styles.navLink} >
        <div className={styles.div}>
          {isMobileView}
          <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 912 ? 25 : 50} fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
