    ...
    <div className={styles.rightSection}>
      <Link to={"/"} className={styles.navLink} >
        <div className={styles.div}>
          <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-house" viewBox="0 0 16 16">
      ...
      ( 
        ...
        <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-box-arrow-in-right" viewBox="0 0 16 16">
      ...
      <div onClick={handleThemeToggle} className={styles.color} style={{borderLeft: chessColor.border}}>
        <div className={styles.div}>
          {
            theme === 0 ? 
            <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-brightness-high-fill" viewBox="0 0 16 16">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width={isMobileView >= 1125 ? 25 : 50} height={isMobileView >= 1125 ? 25 : 50} fill="currentColor" className="bi bi-moon-stars-fill" viewBox="0 0 16 16">
