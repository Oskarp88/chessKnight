...
export function Home() {
  ...
  return (
    <div className={style.container} style={auth?.user ? {background: chessColor.fondo, height: '100%'}: {background: chessColor.fondo}}>
         ...
         <div className={style.containerNivel}>
          ...
          <div className={style.containerDatos}>
             <div className={style.span}>
                <span>Total juegos: {stast.games}</span>
                <span>Gananas: {stast.won}</span>
                <span>Perdidas: {stast.lost}</span>
                <span>Empate: {stast.tied}</span>
                <span>Racha Actual: {stast.racha}</span>
             </div>
          </div>
         </div>
      </div>
