...
export function Home() {
  ...
  return (
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div  className={style.containerStats}>
             <button className={style.playButton}>Fast <FastSvg/></button>
             <button className={style.playButton}>blitz <BlitzSvg/></button>
             <button className={style.playButton}>bullet <BulletSvg/></button>
      </div>
      { showModalMin &&
