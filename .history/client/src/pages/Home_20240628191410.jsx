    ...
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div className={style.containerStats}>
         <div className={style.containerNivel}>
           ...
           <svg style={{ color: '#80de83', marginLeft: '10px', marginTop: '5px' }} xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
