      ...
      <div className={style.image}>
        <div className={style.home}>
          <div className={style.homestyle}>
            <h1 className={style.titulo}>Bienvenidos a ChessNKIGHT</h1>
            <p>Juega ajedrez online y mejora tus habilidades!</p>
            <button className={style.playButton} onClick={joinRoom}>
               Unirse a una sala
            </button>
          </div> 
