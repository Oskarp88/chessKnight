...
export function Home() {
  ...
  const [stast, setStats] = useState({
    ...
    tied: user.gamesTiedFast,
    won: user.gamesWonFast,
    lost: user.gamesLostFast,
  ...
  const handleClick = (data) => {
     ...
     if(data === 'blitz'){
        setStats({
          ...
          tied: user.gamesTiedBlitz,
          won: user.gamesWonBlitz,
          lost: user.gamesLostBlitz,
     ...
     if(data === 'bullet'){
      setStats({
        ...
        tied: user.gamesTiedBullet,
        won: user.gamesWonBullet,
        lost: user.gamesLostBullet,
      ...
      <div className={style.containerStats}>
         <div className={style.containerNivel}>
           <div className={style.svg}>
                   {stast.time === 'fast' ? 
                      <svg style={{ color: '#80de83', marginLeft: '10px', marginTop: '5px' }} xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" class="bi bi-clock" viewBox="0 0 16 16">
                        <path d="M8 3.5a.5.5 0 0 0-1 0V9a.5.5 0 0 0 .252.434l3.5 2a.5.5 0 0 0 .496-.868L8 8.71z"/>
                        <path d="M8 16A8 8 0 1 0 8 0a8 8 0 0 0 0 16m7-8A7 7 0 1 1 1 8a7 7 0 0 1 14 0"/>
                      </svg> :
                    stast.time === 'blitz' ?
                    <svg style={{ color: '#FFEB3B', marginLeft: '10px', marginTop: '5px' }} xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-lightning-charge-fill" viewBox="0 0 16 16">
                        <path d="M11.251.068a.5.5 0 0 1 .227.58L9.677 6.5H13a.5.5 0 0 1 .364.843l-8 8.5a.5.5 0 0 1-.842-.49L6.323 9.5H3a.5.5 0 0 1-.364-.843l8-8.5a.5.5 0 0 1 .615-.09z"/>
                    </svg> :
                     <svg style={{ color: '#F9A825', marginLeft: '10px',  marginTop: '5px' }} xmlns="http://www.w3.org/2000/svg" width="80" height="80" fill="currentColor" className="bi bi-rocket-takeoff-fill" viewBox="0 0 16 16">
              ...
              {stast?.elo < 21 ? <PrincipianteInsignia /> : 
                        stast?.elo >= 21 && stast?.elo <= 61 ? <NovatoInsignia /> : 
                        stast?.elo >= 62 && stast?.elo <= 100 ? <IntermedioInsignia /> : 
                        stast?.elo >= 101 && stast?.elo <= 230 ? <AvanzadoInsignia /> :
                        stast?.elo >= 231 && stast?.elo <= 390 ? <ExpertoInsignia /> :
                        stast?.elo >= 391 && stast?.elo <= 549 ? <MaestroIngsinia /> : 
                        <GranMaestroInsignia/> }
              <p>{stast.elo}</p>
         </div>
      </div>
