         ...
         <div className={style.containerNivel}>
          ...
          <div className={style.rating}>
              <div className={style.insignia}>
                ...
                <p style={{color: chessColor.titulo}}>{ stast === 'fats' ? user.eloFast :
          ...
          <div className={style.containerDatos}>
             <div className={style.span}>
                ...
                <div>
                    ...
                    <span style={{color: chessColor.titulo}}>
                      {stast === 'fast' ? user?.wonFast : stast === 'blitz' ? user.wonBlitz : user.wonBullet}
                    </span>
                </div>
                <div>
                  <span style={{color: chessColor.color}}>Perdidas: </span>
                  <span style={{color: chessColor.titulo}}>
                    {stast === 'fast' ? user?.lostFast : stast === 'blitz' ? user?.lostBlitz : user?.lostBullet}
                  </span>
                </div>
             ...
             <div className={style.span}>
                <div>
                  ...
                  <span style={{color: chessColor.titulo}}>
                    {stast === 'fast' ? user?.tiedFast : stast === 'blitz' ? user.tiedBlitz : user.tiedBullet}
                  </span>
                </div>
                <div>
