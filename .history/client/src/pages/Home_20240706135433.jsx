...
export function Home() {
  ...
  return (
    <div className={style.container} style={auth?.user ? {background: chessColor.fondo, height: '100%', paddingBottom: '4rem'}: {background: chessColor.fondo}}>
      ...
      <div className={style.fondoDatos}>
        ...
        <div  className={style.containerStats}>
              <button 
                ...
                style={stast === 'fast' ?{background: chessColor.navbar, opacity: '80%', border: `2px solid ${chessColor.color}`} : {background: chessColor.navbar}}
              ...
              <button 
                  className={style.buttonStats} 
                  style={stast === 'blitz' ?{background: chessColor.navbar, opacity: '80%', border: `2px solid ${chessColor.titulo}`} : {background: chessColor.navbar}}
              ...
              <button 
                className={style.buttonStats} 
                style={stast === 'bullet' ?{background: chessColor.navbar, opacity: '80%', border: `2px solid ${chessColor.color}`} : {background: chessColor.navbar}}
