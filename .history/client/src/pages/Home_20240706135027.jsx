      ...
      <div className={style.fondoDatos}>
        ...
        <div  className={style.containerStats}>
              <button 
                ...
                style={stast === 'fast' ?{background: chessColor.navbar, opacity: '80%'} : {background: chessColor.navbar}}
              ...
              <button 
                  className={style.buttonStats} 
                  style={stast === 'blitz' ?{background: chessColor.navbar, opacity: '80%'} : {background: chessColor.navbar}}
              ...
              <button 
                className={style.buttonStats} 
                style={stast === 'bullet' ?{background: chessColor.navbar, opacity: '80%', border: `5px solid ${chessColor.color}`} : {background: chessColor.navbar}}
