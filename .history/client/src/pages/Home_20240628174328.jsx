...
export function Home() {
  ...
  return (
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div  className={style.containerStats}>
             <button className={style.playButton} style={{background: chessColor.navbar}}>Fast <FastSvg/></button>
             <button className={style.playButton} style={{background: chessColor.navbar}}>blitz <BlitzSvg/></button>
             <button className={style.playButton} style={{background: chessColor.navbar}}>bullet <BulletSvg/></button>
      </div>
      { showModalMin &&
