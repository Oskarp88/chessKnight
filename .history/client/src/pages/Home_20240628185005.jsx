...
export function Home() {
  ...
  return (
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div>
         <div>
         {user?.elo < 21 ? <PrincipianteInsignia /> : 
                    user?.elo >= 21 && user?.elo <= 61 ? <NovatoInsignia /> : 
                    user?.elo >= 62 && user?.elo <= 100 ? <IntermedioInsignia /> : 
                    user?.elo >= 101 && user?.elo <= 230 ? <AvanzadoInsignia /> :
                    user?.elo >= 231 && user?.elo <= 390 ? <ExpertoInsignia /> :
                    user?.elo >= 391 && user?.elo <= 549 ? <MaestroIngsinia /> : 
                    <GranMaestroInsignia/> }
         </div>
      </div>
      { showModalMin &&
