...
export function Home() {
  ...
  return (
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div  className={style.containerStats}>
             <button  style={{background: chessColor.navbar}}>Fast <FastSvg/></button>
             <button style={{background: chessColor.navbar}}>blitz <BlitzSvg/></button>
             <button  style={{background: chessColor.navbar}}>bullet <BulletSvg/></button>
      </div>
      { showModalMin &&
