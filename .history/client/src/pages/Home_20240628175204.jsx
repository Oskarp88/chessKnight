...
export function Home() {
  ...
  return (
    <div className={style.container} style={{background: chessColor.fondo}}>
      ...
      <div  className={style.containerStats}>
             <button className={style.buttonStats} style={{background: chessColor.navbar}}>Fast <FastSvg/></button>
             <button className={style.buttonStats} style={{background: chessColor.navbar}}>Blitz <BlitzSvg/></button>
             <button className={style.buttonStats} style={{background: chessColor.navbar}}>Bullet <BulletSvg/></button>
      </div>
      { showModalMin &&
